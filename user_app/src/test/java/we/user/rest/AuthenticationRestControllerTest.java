...
import we.user.model.security.Authority;
import we.user.model.security.AuthorityName;
import we.user.model.security.User;
import we.user.security.JwtAuthenticationRequest;
import we.user.security.JwtTokenUtil;
import we.user.security.JwtUser;
import we.user.security.JwtUserFactory;
